const AboutInformation = () => {
  return (
    <div className="h-1/2 space-y-3 px-3 lg:h-auto lg:w-1/2">
      <h1 className="animate-fade-down bg-gradient-to-b from-primary from-50% to-background bg-clip-text text-center text-4xl font-bold text-transparent animate-duration-1000 animate-once animate-ease-in-out md:text-5xl lg:text-left lg:text-6xl">
        Get it done, then make it beautiful.
      </h1>
      <p className="animate-fade py-6 text-justify text-muted-foreground animate-delay-500 animate-duration-1000 animate-once animate-ease-in-out">
