...
import { idlFactory } from './ts-react-portfolio.did.js';
export { idlFactory } from './ts-react-portfolio.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TS_REACT_PORTFOLIO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ts-react-portfolio.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ts-react-portfolio canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ts-react-portfolio.did.js")._SERVICE>}
 */
export const ts_react_portfolio = createActor(canisterId);
